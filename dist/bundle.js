...
class State {
  ...
  update(time, keys) {
    ...
    switch (this.level.touching(player.pos, player.size)) {
      ...
      // break;
      case "trampoline":
        newState.player.gravity = -newState.player.gravity * 20;
        return new State(newState);
      default:
        break;
    }
